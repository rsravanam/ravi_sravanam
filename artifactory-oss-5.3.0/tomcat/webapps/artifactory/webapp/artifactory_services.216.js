...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ApiConstants = _interopRequire(__webpack_require__(88));

	var ArtifactoryCookies = __webpack_require__(143).ArtifactoryCookies;

	var ArtifactoryHttpClient = __webpack_require__(144).ArtifactoryHttpClient;

	var ArtifactoryStorage = __webpack_require__(145).ArtifactoryStorage;

	var ArtifactoryXmlParser = __webpack_require__(146).ArtifactoryXmlParser;

	var UserFactory = __webpack_require__(147).UserFactory;

	var ArtifactoryState = __webpack_require__(148).ArtifactoryState;

	var artifactorySessionInterceptor = __webpack_require__(149).artifactorySessionInterceptor;

	var artifactoryDebugInterceptor = __webpack_require__(150).artifactoryDebugInterceptor;

	var artifactorySpinnerInterceptor = __webpack_require__(151).artifactorySpinnerInterceptor;

	var artifactoryMessageInterceptor = __webpack_require__(152).artifactoryMessageInterceptor;

	var artifactoryServerErrorInterceptor = __webpack_require__(153).artifactoryServerErrorInterceptor;

	var ArtifactoryModelSaverFactory = __webpack_require__(154).ArtifactoryModelSaverFactory;

	var ArtifactoryFeatures = __webpack_require__(155).ArtifactoryFeatures;

	var GoogleAnalytics = __webpack_require__(156).GoogleAnalytics;

	var NativeBrowser = __webpack_require__(157).NativeBrowser;

	var ArtifactActions = __webpack_require__(158).ArtifactActions;

	var SetMeUpModal = __webpack_require__(161).SetMeUpModal;

	var ArtifactoryDeployModal = __webpack_require__(164).ArtifactoryDeployModal;

	var PushToBintrayModal = __webpack_require__(165).PushToBintrayModal;

	var parseUrl = __webpack_require__(166).parseUrl;

	var recursiveDirective = __webpack_require__(167).recursiveDirective;

	var AdvancedStringMatch = __webpack_require__(168).AdvancedStringMatch;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RC = _interopRequire(__webpack_require__(88));
	    ...
	    _createClass(GoogleAnalytics, {
	        _setUpGA: {
	            value: function _setUpGA() {
	                ...
	                if (this.allowGA) {
	                    ...
	                    // document.onclick = () => {this._action()};
	                    // document.onmousemove = () => {this._action()};
	                    // document.onkeypress = () => {this._action()};

	                    // this.GA._idleSecondsTimer = this.$interval(() => this.CheckIdleTime(), 1000);

	                    var uaCode = _.includes(this.footerDao.getInfo().buildNumber, "SNAPSHOT") ? "UA-87840116-1" : "UA-87840116-2";
	        ...
	        trackEvent: {
	            value: function trackEvent(eventCategory, eventAction) {
	                var eventLabel = arguments[2] === undefined ? "" : arguments[2];
	                var eventValue = arguments[3] === undefined ? null : arguments[3];
	                var dimension1 = arguments[4] === undefined ? "" : arguments[4];
	                var dimension2 = arguments[5] === undefined ? "" : arguments[5];
	                var dimension3 = arguments[6] === undefined ? "" : arguments[6];
	        ...
	        _resetCounter: {
	            ...
	            // CheckIdleTime() {
	            //     this.GA._idleSecondsCounter++;
	            //
	            //     if (this.GA._idleSecondsCounter >= this.GA.IDLE_TIMEOUT && this.GA.active) {
	            //         // Turn off interval
	            //         this.GA.active = false;
	            //         this.$interval.cancel(this.GA._idleSecondsTimer);
	            //         // send end session event event
	            //         if (this.allowGA && window.ga) window.ga('send', 'event',{'sessionControl': 'end'});
	            //     }
	            // }
	        ...
	        _doDeleteContent: {
	            value: function _doDeleteContent(node) {
	                ...
	                this.modal.confirm("Are you sure you want to delete the content of this repository? All artifacts will be" + (permanent ? " <span class=\"highlight-alert\">permanently</span> " : " ") + "deleted.", "Delete Content Of '" + node.data.text + "'", { confirm: "Delete Content" }).then(function () {
	                    ...
	                    return _this.JFrogEventBus.dispatch(EVENTS.ACTION_DELETE, node);
	                });
	            }
	        },
	        _doDeleteVersions: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SNIPPETS = _interopRequire(__webpack_require__(162));
	    ...
	    _createClass(SetMeUpModal, {
	                ...
	                if (repoType != "maven" && (repoData.local || repoData.defaultDeploymentConfigured) && this.setMeUpScope.snippets[repoType].deploy) {
	                    ...
	                    if (this.setMeUpScope.snippets[repoType].deploy instanceof Array) {
	                        for (var i = 0; i < this.setMeUpScope.snippets[repoType].deploy.length; i++) {
	                            ...
	                            if (tpl) {
	                                tpl = tpl.replace(/\$1/g, repoData.text).replace(/\$2/g, this.setMeUpScope.baseUrl).replace(/\$3/g, this.setMeUpScope.serverId).replace(/\$4/g, this.setMeUpScope.host).replace(/\$5/g, this.setMeUpScope.cleanHost);
	                ...
	                if (this.setMeUpScope.snippets[repoType].general) {
	                    if (this.setMeUpScope.snippets[repoType].general instanceof Array) {
	                        for (var i = 0; i < this.setMeUpScope.snippets[repoType].general.length; i++) {
	                            ...
	                            if (tpl && repoData) {
	                                tpl = tpl.replace(/\$1/g, repoData.text).replace(/\$2/g, this.setMeUpScope.baseUrl).replace(/\$3/g, this.setMeUpScope.serverId).replace(/\$4/g, repoType === "cocoapods" ? this.setMeUpScope.host.split(":")[0] : this.setMeUpScope.host).replace(/\$5/g, this.setMeUpScope.cleanHost);
	                                tpl = this._fixTPL(tpl);
	                            }
	        ...
	        _prepareSnippets: {
	            value: function _prepareSnippets(injectUserData) {
	                ...
	                if (injectUserData) {
	                    if (this.injectionData.userName && this.injectionData.password) {
	                        stringified = stringified.split("<USERNAME>:<PASSWORD> (converted to base 64)").join(btoa(this.injectionData.userName.toLowerCase() + ":" + this.injectionData.password));
	                    }
...
/***/ (function(module, exports) {
	...
	var snippets = {
	    ...
	    npm: {
	        general: [{
	            title: "In order for your npm command line client to work with Artifactory you will first need to set the relevant authentication. For getting authentication details run the following command:",
	            ...
	            before: "The response should be pasted in the <i>~/.npmrc</i> (in Windows %USERPROFILE%/<i>.npmrc</i>) file. Here is an example of the content of the file:",
	            snippet: "@<SCOPE>:registry=$2/api/npm/$1/\n" + "////$2/api/npm/$1/:_password=<BASE64_PASSWORD>\n" + "////$2/api/npm/$1/:username=<USERNAME>\n" + "////$2/api/npm/$1/:email=youremail@email.com\n" + "////$2/api/npm/$1/:always-auth=true"
	        }, {
	    ...
	    _createClass(ArtifactoryDeployModal, {
	        ...
	        createNotification: {
	            ...
	            value: function createNotification(response) {
	                ...
	                var messageWithUrl = "Successfully deployed <a href=\"#/artifacts/browse/tree/General/" + repoKey + "/" + artifactPath + "\">" + this.jfrogUtils.getSafeHtml(artifactPath) + "</a> to " + repoKey;
	            ...
	            value: function show() {
	                ...
	                whenReady.then(function () {
	                    ...
	                    if (!quickSetup && !_this.initStatus.hasLicenseAlready && !_this.features.isAol() && !_this.features.isOss()) steps.push({
	                        ...
	                        id: "license",
	                        icon: "images/wizard-icons/icon_1_idle_gif.216.gif",
	                        iconSrcset: "images/wizard-icons/icon_1_idle_gif@2.216.gif 2x, images/wizard-icons/icon_1_idle_gif@3.216.gif 3x",
	                        buildIcon: "images/wizard-icons/icon_1_build_gif.216.gif",
	                        buildIconSrcset: "images/wizard-icons/icon_1_build_gif@2.216.gif 2x, images/wizard-icons/icon_1_build_gif@3.216.gif 3x",
	                    ...
	                    if (!quickSetup && !_this.user.isAdmin() && _this.initStatus.hasPriorLogins) steps.push({
	                        name: "Admin Login",
	                        id: "login",
	                        icon: "images/wizard-icons/icon_2_idle_gif.216.gif",
	                        iconSrcset: "images/wizard-icons/icon_2_idle_gif@2.216.gif 2x, images/wizard-icons/icon_2_idle_gif@3.216.gif 3x",
	                        buildIcon: "images/wizard-icons/icon_2_build_gif.216.gif",
	                        buildIconSrcset: "images/wizard-icons/icon_2_build_gif@2.216.gif 2x, images/wizard-icons/icon_2_build_gif@3.216.gif 3x",
	                    ...
	                    if (!quickSetup && !_this.features.isAol() && !_this.initStatus.hasProxies) steps.push({
	                        ...
	                        id: "proxy",
	                        icon: "images/wizard-icons/icon_3_idle_gif.216.gif",
	                        iconSrcset: "images/wizard-icons/icon_3_idle_gif@2.216.gif 2x, images/wizard-icons/icon_3_idle_gif@3.216.gif 3x",
	                        buildIcon: "images/wizard-icons/icon_3_build_gif.216.gif",
	                        buildIconSrcset: "images/wizard-icons/icon_3_build_gif@2.216.gif 2x, images/wizard-icons/icon_3_build_gif@3.216.gif 3x",
	                    ...
	                    steps.push({
	                        ...
	                        id: "packageTypes",
	                        icon: "images/wizard-icons/icon_4_idle_gif.216.gif",
	                        iconSrcset: "images/wizard-icons/icon_4_idle_gif@2.216.gif 2x, images/wizard-icons/icon_4_idle_gif@3.216.gif 3x",
	                        buildIcon: "images/wizard-icons/icon_4_build_gif.216.gif",
	                        buildIconSrcset: "images/wizard-icons/icon_4_build_gif@2.216.gif 2x, images/wizard-icons/icon_4_build_gif@3.216.gif 3x",
	                    ...
	                    steps.push({
	                        ...
	                        id: "summary",
	                        icon: "images/wizard-icons/icon_5_idle_gif.216.gif",
	                        iconSrcset: "images/wizard-icons/icon_5_idle_gif@2.216.gif 2x, images/wizard-icons/icon_5_idle_gif@3.216.gif 3x",
	                        buildIcon: "images/wizard-icons/icon_5_build_gif.216.gif",
	                        buildIconSrcset: "images/wizard-icons/icon_5_build_gif@2.216.gif 2x, images/wizard-icons/icon_5_build_gif@3.216.gif 3x",
