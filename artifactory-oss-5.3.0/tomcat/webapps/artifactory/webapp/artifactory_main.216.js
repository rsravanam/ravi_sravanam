...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Models = _interopRequire(__webpack_require__(140));

	var ValidationConstants = _interopRequire(__webpack_require__(142));

	var EVENTS = _interopRequire(__webpack_require__(48));

	if (angular.version.full !== "1.5.8") console.log("%cWrong AngularJS version!", "color: #ff0000;");
	...
	function appConfig($stateProvider, $urlRouterProvider, ngClipProvider, $httpProvider, JFrogUILibConfigProvider) {
	    ...
	    ngClipProvider.setPath("css/ZeroClipboard.216.swf");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var AdminMenuItems = __webpack_require__(141).AdminMenuItems;
